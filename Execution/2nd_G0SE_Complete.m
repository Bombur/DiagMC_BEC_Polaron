...
(* ::Title:: *)
(*2nd Order Complete G0SE Diagram in \[Tau] p=0*)
...
IntegBEC[q1_,q2_,\[Tau]_,\[Tau]1_, \[Tau]2_, \[Tau]3_,ctheta_] := vq2[q1]*vq2[q2]*g0[0,0,\[Tau]1]*g0[q1,\[Tau]1,\[Tau]2]*dq[q1,\[Tau]1,\[Tau]]*g0cos[q1,q2,\[Tau]2,\[Tau]3, ctheta]*dq[q2,\[Tau]2,\[Tau]3]*g0[q1,\[Tau]3,\[Tau]];
...
(*LogPlot[se2rainb[t],{t, 0,10}, PlotPoints -> 10, MaxRecursion->3, PlotRange -> Full]*)
...
g0se2data = Table[{t, g0se2rainb[t]+g0se2oth[t]}, {t, taus}]


Export["data/mat_2nd_g0se_complete", g0se2data, "Table"];
